...
class DXPatches
{
  protected:
    ...
    std::vector<std::string> validHashes = {
        std::string("FD4264BC92F1839E3A85E1ECDA00526B"), std::string("E66949629A5D2637C4ED682765584C99"),
        std::string("DAEFC008E8A2629778131C7190C70B38"), std::string("C33947D5980D9753190909543D48A974"),
        std::string("AFD1442815D3B93F3721B4D97EAE31C4"), std::string("AC7D1BD514CBD4F4B6A7559E08189693"),
        std::string("6205806AF22FDD40150E14EC5ACA2A8F"), std::string("95F47E5172B07E86D47060325F7E9507"),
        std::string("34A2F2CAF9DE3B79541B7D22795213F7"), std::string("9EB812D6530E13113418122F7670ABA7"),
        std::string("8B52524CAC994866B36083BE460741DA"), std::string("7DEF0E6CB22B743962FCB50F0333D5C6"),
