...
void McGamesXML::generate(std::string filename)
{
    ...
    xml.PushComment(" This file was made using PandoryTool. Unlock your Pandora Box! https://teampandory.com");
    xml.PushComment(" Like our work? Support us on Patreon! https://teampandory.com/donate ");
    // # Game
    ...
    if (additionalRomName != "")
    {
        xml.OpenElement("rom");
        xml.PushAttribute("name", additionalRomName.c_str());
        xml.CloseElement();
    }
