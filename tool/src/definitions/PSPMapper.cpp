...
PSPMapper::PSPMapper()
{
    ...
    stockGames["WWEAllStar"] = {0, 1, 2, "ULUS10544"};
    ...
    controlFixes["MortalKombat"] = {"Mortal Kombat",
    ...
    controlFixes["GuiltyGear"] = {"Guilty Gear",
    ...
    */
    ...
    controlFixes["WWEAllStar"] = {"WWE All-Stars",
